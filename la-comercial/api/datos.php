...
if(isset($_GET['tabla'])) {
    ...
    if(isset($_GET['accion'])) {
        ...
        // --------- SUBIDA DE IMAGENES ----------
        if(
            isset($_FILES) && // Si está seteado el array $_FILES
            isset($_FILES['imagen']) && // Si está seteado el parámetro $_FILES['imagen']
            !empty($_FILES['imagen']['name']) && // NO está vacio $_FILES['imagen']['name'] y
            !empty($_FILES['imagen']['tmp_name']) // NO está vacio $_FILES['imagen']['tmp-name']
        ){
